...
globalThis.window = { location: { href: 'https://www.google.com/travel/search?qs=OAA' } };
globalThis.document = {
  querySelector: () => null,
  querySelectorAll: () => [],
  dispatchEvent: () => {},
...
globalThis.WebMCPHelpers = {
  ...
  waitForGoogleHotelsResults: () => Promise.resolve(true),
  parseGoogleHotelCard: () => ({}),
  setSliderValue: () => {},
};

const toolDir = join(__dirname, '../content/sites/google-hotels/tools');
...
describe('Google Hotels tool schemas', () => {
